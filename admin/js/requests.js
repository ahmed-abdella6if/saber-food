...
async function deleteQuote(id) {
    ...
    if (!confirm(window.saberT ? window.saberT("Delete this quote?") : "Delete this quote?")) return;
...
function viewQuote(id){
    ...
    document.getElementById("drawerNotes").textContent =
        quote.notes || (window.saberT ? window.saberT("No Notes") : "No Notes");
...
.on(
    ...
    showSuccess(window.saberT ? window.saberT("New quote  received") : "New quote  received");
